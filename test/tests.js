...
var identifier = new RegionIdentifier();
const fs = require('fs');
identifier.get('AT', '2151', console.log);
identifier.get('ARG', '58040', console.log);
identifier.get('MX', '35078', console.log);
...
fs.readFile('./CH.txt', function(err, data) {
	...
	fs.writeFile('./regions/CHE.json', JSON.stringify(result), console.log);
});